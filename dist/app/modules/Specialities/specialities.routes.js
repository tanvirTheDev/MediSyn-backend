...
router.post("/", (0, auth_1.default)(prisma_1.UserRole.ADMIN, prisma_1.UserRole.SUPER_ADMIN), fileUploader_1.fileUploader.upload.single("file"), specialities_controller_1.SpecialitiesController.createSpecialities);
